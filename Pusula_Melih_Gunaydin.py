...
def visualize_data(df, chart_type):
    ...
    switch = {
        ...
        'Cinsiyet': lambda: plot_pie_chart(df['Cinsiyet'].value_counts().values,
                                           ...
                                           'Cinsiyet Dağılımı (Null Değerler Hariç)'),

        ############################################## Yaş Değişkeni Görselleştirme ##############################################
        'Yaş': lambda: plot_histogram(df['Yaş'], 'Yaş Dağılımı (Null Değerler Hariç)'),

        ############################################## İl Değişkeni Görselleştirme ##############################################
        'İl': lambda: plot_pie_chart(df['Il'].value_counts().values,
                                     df['Il'].value_counts().index,
                                     'İl Dağılımı (Null Değerler Hariç)'),
        ...
        'Yan Etki': lambda: plot_pie_chart(df['Yan_Etki'].value_counts().values,
                                           ...
                                           'Yan Etki Dağılımı (Null Değerler Hariç)'),
        ...
        'Kilo': lambda: plot_histogram(df['Kilo'], 'Kilo Dağılımı (Null Değerler Hariç)'),

        ############################################## Boy Değişkeni Görselleştirme ##############################################
        'Boy': lambda: plot_histogram(df['Boy'], 'Boy Dağılımı (Null Değerler Hariç)'),
        ...
        'Alerji': lambda: plot_pie_chart(df['Alerjilerim'].value_counts().values,
                                         ...
                                         'Alerji Dağılımı (Null Değerler Hariç)')
    }
...
# Örnek kullanım:
visualize_data(df, 'Kronik Hastalık Ayrı')  # Grafik türünü buraya belirtin.
